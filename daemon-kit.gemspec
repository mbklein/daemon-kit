...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".gitignore",
     ...
     "lib/generators/daemon_kit/stomp/USAGE",
     "lib/generators/daemon_kit/stomp/stomp_generator.rb",
     "lib/generators/daemon_kit/stomp/templates/config/stomp.yml",
     "lib/generators/daemon_kit/stomp/templates/config/pre-daemonize/stomp.rb",
     "lib/generators/daemon_kit/stomp/templates/libexec/%app_name%-daemon.rb",
